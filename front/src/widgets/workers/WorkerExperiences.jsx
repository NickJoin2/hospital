    ...
    return (
        <div
            ...
            <form
                ...
                <h1 className="font-medium text-center text-xl" style={{marginTop: "-5px"}}>Опыт сотрудника
                </h1>
                ...
                <div>
                    ...
                    >
                        <Button maxWidth={462}
                                className="text-sm font-medium w-full">{selected || 'Выберите сотрудника'}</Button>
                    </SelectMenu>
                </div>
                ...
                <div>
                    <TextInput
                        placeholder="Введите обязаности"
                        type="text"
                        required
                        maxWidth={462}
                        className="text-sm font-medium w-full placeholder-gray-400"
