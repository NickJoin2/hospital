    ...
    return (
        <div
            ...
            <form
                ...
                <h1 className="font-medium text-center text-xl" style={{marginTop: "-5px"}}>Госпитализация
                </h1>

                <div>
                    <SelectMenu
                        title="Выберите тип госпитализации"
                    ...
                    >
                        <Button maxWidth={462}
                                className="text-sm font-medium w-full">{selected || 'Выберите тип госпитализации'}</Button>
                    </SelectMenu>
                </div>
                ...
                <div>
                    <TextInput
                        placeholder="Введите дату госпитализации"
                        type="date"
                        required
                        maxWidth={462}
