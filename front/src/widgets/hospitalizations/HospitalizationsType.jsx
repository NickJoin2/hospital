    ...
    return (
        <div
            ...
            <form
                ...
                <h1 className="font-medium text-center text-xl" style={{marginTop: "-5px"}}>Создать тип госпитализации
                </h1>

                <div>
                    <TextInput
                        placeholder="Введите тип госпитализации"
                        type="text"
                        required
                        maxWidth={462}
...
export default HospitalizationsType;