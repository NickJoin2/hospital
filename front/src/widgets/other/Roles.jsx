...
const Roles = () => {
    return (
        <div className="h-[100vh] w-[100vw] flex justify-center items-center bg-secondary-900 bg-opacity-75 absolute top-0 left-0 z-1">
            <form
                ...
                <h1 className="font-medium text-center text-xl" style={{marginTop: '-5px'}}>Создать роль</h1>

                <div>
                    <TextInput
                        name="code"
                        placeholder="Введите code роли"
                        type="text"
                        required
                        maxWidth={462}
