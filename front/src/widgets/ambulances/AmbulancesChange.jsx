    ...
    return (
        <div
            ...
            <form
                ...
                <h1 className="font-medium text-center text-xl" style={{marginTop: "-5px"}}>Машина скорой помощи</h1>


                <div>
                    <SelectMenu
                        title="Выберите начальное время"
                    ...
                    >
                        <Button maxWidth={462}
                                className="text-sm font-medium w-full">{selected || 'Выберите начальное время'}</Button>
                    </SelectMenu>
                </div>

                <div>
                    <SelectMenu
                        title="Выберите коннечное время"
                        options={['Apple', 'Apricot', 'Banana', 'Cherry', 'Cucumber'].map((label) => ({
                            label,
                            value: label
                        }))}
                    ...
                    >
                        <Button maxWidth={462}
                                className="text-sm font-medium w-full">{selected || 'Выберите коннечное время'}</Button>
                    </SelectMenu>
                </div>
                ...
                <div>
                    ...
                    >
                        <Button maxWidth={462}
                                className="text-sm font-medium w-full">{selected || 'Выберите день недели'}</Button>
                    </SelectMenu>
                </div>
...
export default AmbulancesChange;