    ...
    return (
        <div
            ...
            <form
                ...
                <h1 className="font-medium text-center text-xl" style={{marginTop: "-5px"}}>Машина скорой помощи
                </h1>
                ...
                <div>
                    ...
                    >
                        <Button maxWidth={462}
                                className="text-sm font-medium w-full">{selected || 'Выберите доктора'}</Button>
                    </SelectMenu>
                </div>
                ...
                <div>
                    ...
                    >
                        <Button maxWidth={462}
                                className="text-sm font-medium w-full">{selected || 'Выберите водителя'}</Button>
                    </SelectMenu>
                </div>
                ...
                <div>
                    ...
                    >
                        <Button maxWidth={462}
                                className="text-sm font-medium w-full">{selected || 'Выберите смену'}</Button>
                    </SelectMenu>
                </div>
