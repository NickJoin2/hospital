    ...
    return (
        <div
            ...
            <form
                ...
                <h1 className="font-medium text-center text-xl" style={{marginTop: "-5px"}}>Создать частоту приема
                </h1>
                ...
                <div>
                    ...
                    >
                        <Button maxWidth={462}
                                className="text-sm font-medium w-full">{selected || 'Название компании'}</Button>
                    </SelectMenu>
                </div>
